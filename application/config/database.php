...
/* require_once APPPATH.'../dbconnect.php'; */
...
$db['default']['dsn'] 	   = $db['default']['dbdriver'] . '://' . $db['default']['username'] . ':' . $db['default']['password']. '@' . $db['default']['hostname'] . '/' . $db['default']['database'];
...
$conn = Doctrine_Manager::connection($db['default']['dsn']);
