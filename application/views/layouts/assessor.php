...
<aside id="menu">
    <div id="navigation">
        <div class="profile-picture">
            <a href="#">
				<?php $pic_path=BASE_URL.'/public/images/male_user.jpg';
				if(isset($loguserid['assessor_id'])){ $pic_path=(!empty($logempid->assessor_photo))?BASE_URL.'/public/uploads/assessor_pic/'.$loguserid['assessor_id'].'/'.trim($logempid->assessor_photo):BASE_URL.'/public/images/male_user.jpg'; } ?>
            ...
            <div class="stats-label text-color">
				...
				if(empty($loguserid['assessor_id'])){
					...
					echo ucwords(strtolower(@$logempid->assessor_name));
				}
                ...
                <div class="dropdown">
                    ...
                    <a class="dropdown-toggle" href="#" data-toggle="dropdown">
                        <small class="text-muted">Welcome, <?php  echo @$logempid->assessor_name; ?> <b class="caret"></b></small>
                    </a>
