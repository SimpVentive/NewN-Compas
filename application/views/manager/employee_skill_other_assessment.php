				...
				<div class="report-view-section custom-scroll">
					<div class="report-view-block">
						<table class="idp-report-table table-bordered table" style="width:1050px">
							<tr>
								<th colspan="5" class="report-title">Skill evaluation position</th>
							</tr>
							<tr>
							...
							<tr>
								...
								?>
								<a href="<?php echo BASE_URL; ?>/manager/employee_skill_evaluation_details?type=2&emp_id=<?php echo $sup_emps['employee_id']; ?>&ass_id=<?php echo $sup_emps['assessment_id']; ?>&pos_id=<?php echo $sup_emps['pos_id']; ?>&atest_id=<?php echo $sup_emps['event_id']; ?>&stype=<?php echo $sup_emps['skill_type']; ?>" class="btn btn-primary">Skill</a>
								<?php 
								}
								else{
								?>
