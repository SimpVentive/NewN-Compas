		...
		<div class="panel-body">
			...
			<div class="col-md-8">
				<div class="form-group">
					...
					<div class="col-sm-7">
						<select name="ass_position_id" id="ass_position_id" class=" form-control m-b" onchange="getpositiontest(<?php echo $_REQUEST['id']; ?>)">
...
jQuery(document).ready(function(){
	getpositiontest(<?php echo $_REQUEST['id']; ?>);
});
