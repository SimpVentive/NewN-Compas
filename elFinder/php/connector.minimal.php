...
$opts = array(
	...
	'roots' => array(
		...
		array(
			...
			'path'          => __SITE_PATH.'/public/uploads/Assessment_Reports',                 // path to files (REQUIRED)
			'URL'           => BASE_URL. '/public/uploads/Assessment_Reports/', // URL to files (REQUIRED)
			'trashHash'     => 't1_Lw',                     // elFinder's hash of trash folder
			'winHashFix'    => DIRECTORY_SEPARATOR !== '/', // to make hash same to Linux one on windows too
			'uploadDeny'    => array('all'),                // All Mimetypes not allowed to upload
			'uploadAllow'   => array('application/pdf','application/zip'), //Mimetype `image` and `text/plain` allowed to upload
		...
		array(
			'id'            => '1',
			'driver'        => 'Trash',
			'path'          => __SITE_PATH.'/public/uploads/Assessment_Reports/.trash/',
			'tmbURL'        => __SITE_PATH.'/public/uploads/Assessment_Reports/.trash/.tmb/',
			'winHashFix'    => DIRECTORY_SEPARATOR !== '/', // to make hash same to Linux one on windows too
