...
if (!defined('__CLASS_HTML2PDF__')) {
    ...
    require_once(LIB_PATH.'/_class/exception.class.php');
    require_once(LIB_PATH.'/_class/locale.class.php');
    require_once(LIB_PATH.'/_class/myPdf.class.php');
    require_once(LIB_PATH.'/_class/parsingHtml.class.php');
    require_once(LIB_PATH.'/_class/parsingCss.class.php');
