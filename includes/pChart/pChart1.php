 ...
 class pChart
  {
   ...
   var $Palette = array("0"=>array("R"=>188,"G"=>224,"B"=>46),
                        ...
                        "8"=>array("R"=>221,"G"=>100,"B"=>46),
                        "9"=>array("R"=>222,"G"=>214,"B"=>46),
                        "10"=>array("R"=>146,"G"=>151,"B"=>224),
                        "11"=>array("R"=>146,"G"=>46,"B"=>224),
                        "12"=>array("R"=>255,"G"=>46,"B"=>117),
                        "13"=>array("R"=>192,"G"=>224,"B"=>46),
   ...
   function pChart($XSize,$YSize)
    {
     ...
     $this->setFontProperties("tahoma.ttf",12);
    }
  ...
  function setLineStyle($Width=1,$DotSize=0)
   ...
   /* This function draw a radar graph centered on the graph area */
	function drawFilledRadar($Data,$DataDescription,$Alpha=0,$BorderOffset=10,$MaxValue=-1){
		$Points      = count($Data);
		$LayerWidth  = $this->GArea_X2-$this->GArea_X1;
		$LayerHeight = $this->GArea_Y2-$this->GArea_Y1;
		$Radius      = ( $this->GArea_Y2 - $this->GArea_Y1 ) / 2 - $BorderOffset;
