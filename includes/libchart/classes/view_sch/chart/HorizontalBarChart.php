<?php
	...
	class HorizontalBarChart extends BarChart {
		 ...
		 */
		public function HorizontalBarChart($width = 600, $height = 250,$i=0) {
			parent::BarChart($width, $height);
			$this->i=$i;
			$this->emptyToFullRatio = 1 / 5;
			$this->plot->setGraphPadding(new Padding(0, 15, 15, 5));
		}
...
//			$imaa1=imagecolorallocate($img, 0xff, 0xff, 0xff);
//			$imaa0=imagecolorallocate($img, 0xdd, 0xdd, 0xdd);
			...
			//imagefilledrectangle($img, 0, 0, 600, 250, "$imaa".$this->i);
