...
while($rows1 = mysqli_fetch_array($result1,MYSQLI_ASSOC)){
	...
	$username="AKIAYPIZEQVRSLLMI6FU";		
	$from_name = "UniTol - Hyderabad";	
	$from_mail="info@n-compas.com";
	$smtp_server="email-smtp.us-east-1.amazonaws.com";
	$smtp_user="info@n-compas.com";
	//$smtp_password="AvxeJhp4F3Gy6xC1hjI8WcIYeF7Ml11nYdbAFA3FY+c3";
	$smtp_password="BF0XnfIRjH9QziUx0jWY/WNWhKIjhiQI4/XJNLTvDq/s";
	$smtp_port=587;
	$smtp_encrypt="tls";
	$client_name="HeadNorth";
	$path="'public'.DS.'uploads'";
	$target_path="";
	if(!empty($attachment)){
		$target_path="/var/www/csft.n-compas.com/public_html/public/".$attachment;
	}
	else{
		$target_path="";
	}
